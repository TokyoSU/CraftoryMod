...
import net.tokyosu.craftory.menu.extendedcrafting.EpicTableMenu;
import net.tokyosu.craftory.screen.extendedcrafting.base.ExCraftingScreenBase;
import org.jetbrains.annotations.NotNull;
import org.joml.Vector2i;

public class EpicCraftingScreen extends ExCraftingScreenBase<EpicTableMenu> {
    public EpicCraftingScreen(@NotNull EpicTableMenu menu, @NotNull Inventory playerInv, @NotNull Component menuName) {
    ...
    public @NotNull Vector2i getSaveButtonPos() {
        return new Vector2i(240, 188);
    }

    @Override
    public @NotNull Vector2i getTrashButtonPos() {
        return new Vector2i(240, 0);
    }

    @Override
    public @NotNull Rect2i getWindowRect() {
        return new Rect2i(0, 244, 266, 208);
    }
