...
public class FluxCrafterMenu extends MenuCraftingBase {
    public FluxCrafterMenu(int containerId, @NotNull Inventory playerInventory, @NotNull Player player) {
        super(MenuRegistry.FLUX_CRAFTER_MENU.get(), containerId, playerInventory);
        this.init(playerInventory);
    }

    public FluxCrafterMenu(int containerId, @NotNull Inventory playerInventory, @NotNull FriendlyByteBuf ignoredFriendlyByteBuf) {
        super(MenuRegistry.FLUX_CRAFTER_MENU.get(), containerId, playerInventory);
        this.init(playerInventory);
    }
