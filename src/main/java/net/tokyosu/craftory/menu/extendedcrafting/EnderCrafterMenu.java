...
public class EnderCrafterMenu extends MenuCraftingBase {
    public EnderCrafterMenu(int containerId, @NotNull Inventory playerInventory, @NotNull Player player) {
        super(MenuRegistry.ENDER_CRAFTER_MENU.get(), containerId, playerInventory);
        this.init(playerInventory);
    }

    public EnderCrafterMenu(int containerId, @NotNull Inventory playerInventory, @NotNull FriendlyByteBuf ignoredFriendlyByteBuf) {
        super(MenuRegistry.ENDER_CRAFTER_MENU.get(), containerId, playerInventory);
        this.init(playerInventory);
    }
