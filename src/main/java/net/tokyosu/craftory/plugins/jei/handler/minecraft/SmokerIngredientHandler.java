...
import net.tokyosu.craftory.screen.minecraft.SmokerScreen;

public class SmokerIngredientHandler extends FurnaceIngredientHandlerBase<SmokerScreen, SmokerMenu> { }
